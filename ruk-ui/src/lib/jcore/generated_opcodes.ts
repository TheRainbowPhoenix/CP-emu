...
type OpcodeStruct = [number, string, number, number, { [name: string]: number }];


// List[Tuple[int, str, int, int, Dict[str, int]]] = [
export const opcodes_table: Array<OpcodeStruct> = [
...
export const abstract_table: Record<number, string> = {
    0: "R{m:d} -> R{n:d}",
